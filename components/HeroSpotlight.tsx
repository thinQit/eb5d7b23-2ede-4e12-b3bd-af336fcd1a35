...
export default function HeroSpotlight({
  headline = "Launch Faster Convert Better Scale Predictably",
  subheadline = "LaunchPilot gives modern SaaS teams the conversion framework, experimentation speed, and insights needed to turn traffic into revenue.",
